...
@Component({
  selector: 'ngx-slider-dragger',
  templateUrl: './slider-dragger.component.html',
  styleUrls: ['./slider-dragger.component.scss'],
})
export class SliderDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = SliderDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
